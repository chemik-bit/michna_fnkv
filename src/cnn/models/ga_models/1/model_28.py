...
def create_model(input_size):
    ...
    x.add(layers.Conv2D(51, (1, 1), activation='relu', padding='same', input_shape=(input_size[0], input_size[1], 1)))
    ...
    x.add(layers.Dense(1176, activation='leaky_relu'))
    x.add(layers.Dense(150, activation='leaky_relu'))

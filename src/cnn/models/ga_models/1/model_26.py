...
def create_model(input_size):
    ...
    x.add(layers.Conv2D(16, (2, 2), activation='sigmoid', padding='same', input_shape=(input_size[0], input_size[1], 1)))
    ...
    x.add(layers.Dense(1975, activation='leaky_relu'))
    x.add(layers.Dense(183, activation='leaky_relu'))

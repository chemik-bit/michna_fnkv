...
def create_model(input_size):
    ...
    x.add(layers.Conv2D(50, (7, 7), activation='sigmoid', padding='same', input_shape=(input_size[0], input_size[1], 1)))
    ...
    x.add(layers.Dense(531, activation='tanh'))
    x.add(layers.Dense(942, activation='tanh'))
    x.add(layers.Dropout(0.5))
    x.add(layers.Dense(1831, activation='relu'))

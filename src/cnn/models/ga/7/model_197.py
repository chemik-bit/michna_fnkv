...
def create_model(input_size):
    ...
    x.add(layers.Conv2D(57, (5, 5), activation='leaky_relu', padding='same', input_shape=(input_size[0], input_size[1], 1)))
    ...
    x.add(layers.BatchNormalization())
    x.add(layers.Conv2D(42, (7, 7), activation='relu', padding='same'))
    x.add(layers.BatchNormalization())
    ...
    x.add(layers.Dense(1693, activation='leaky_relu'))

...
def create_model(input_size):
    ...
    x.add(layers.Conv2D(30, (4, 4), activation='sigmoid', padding='same', input_shape=(input_size[0], input_size[1], 1)))
    ...
    x.add(layers.Dense(1387, activation='tanh'))
    x.add(layers.Dense(449, activation='relu'))

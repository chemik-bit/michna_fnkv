...
def create_model(input_size):
    ...
    x.add(layers.Conv2D(56, (5, 5), activation='leaky_relu', padding='same', input_shape=(input_size[0], input_size[1], 1)))
    ...
    x.add(layers.Dense(1193, activation='sigmoid'))
    x.add(layers.Dense(556, activation='sigmoid'))

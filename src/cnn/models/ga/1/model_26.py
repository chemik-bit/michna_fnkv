...
def create_model(input_size):
    ...
    x.add(layers.Conv2D(57, (6, 6), activation='relu', padding='same', input_shape=(input_size[0], input_size[1], 1)))
    ...
    x.add(layers.Dense(1957, activation='leaky_relu'))
    x.add(layers.Dropout(0.4))
    x.add(layers.Dense(1701, activation='sigmoid'))
    x.add(layers.Dropout(0.3))
    x.add(layers.Dense(388, activation='sigmoid'))

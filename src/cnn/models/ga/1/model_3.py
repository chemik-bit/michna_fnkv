...
def create_model(input_size):
    ...
    x.add(layers.Conv2D(17, (2, 2), activation='sigmoid', padding='same'))
    ...
    x.add(layers.Dense(970, activation='tanh'))
    x.add(layers.Dense(1401, activation='tanh'))
    x.add(layers.Dropout(0.7))
    x.add(layers.Dense(1054, activation='leaky_relu'))

...
def create_model(input_size):
    ...
    x.add(layers.Conv2D(14, (6, 6), activation='sigmoid', padding='same', input_shape=(input_size[0], input_size[1], 1)))
    ...
    x.add(layers.BatchNormalization())
    x.add(layers.Conv2D(53, (7, 7), activation='relu', padding='same'))
    x.add(layers.MaxPooling2D(pool_size=(1, 1), strides=(2, 2)))
    ...
    x.add(layers.Dense(757, activation='relu'))
    x.add(layers.Dense(1298, activation='sigmoid'))

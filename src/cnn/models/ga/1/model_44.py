...
def create_model(input_size):
    ...
    x.add(layers.Conv2D(63, (7, 7), activation='sigmoid', padding='same', input_shape=(input_size[0], input_size[1], 1)))
    ...
    x.add(layers.MaxPooling2D(pool_size=(2, 2), strides=(2, 2)))
    x.add(layers.BatchNormalization())
    x.add(layers.Conv2D(25, (2, 2), activation='leaky_relu', padding='same'))
    ...
    x.add(layers.Dense(1269, activation='relu'))

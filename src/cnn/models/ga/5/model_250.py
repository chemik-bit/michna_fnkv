...
def create_model(input_size):
    ...
    x.add(layers.Conv2D(32, (7, 7), activation='tanh', padding='same', input_shape=(input_size[0], input_size[1], 1)))
    ...
    x.add(layers.Dense(1213, activation='relu'))
    x.add(layers.Dense(218, activation='leaky_relu'))

...
def create_model(input_size):
    ...
    x.add(layers.Conv2D(3, (6, 6), activation='leaky_relu', padding='same', input_shape=(input_size[0], input_size[1], 1)))
    x.add(layers.MaxPooling2D(pool_size=(2, 2), strides=(2, 2)))
    x.add(layers.Conv2D(42, (1, 1), activation='sigmoid', padding='same'))
    ...
    x.add(layers.Dense(762, activation='sigmoid'))

...
def create_model(input_size):
    ...
    x.add(layers.Conv2D(3, (3, 3), activation='sigmoid', padding='same', input_shape=(input_size[0], input_size[1], 1)))
    ...
    x.add(layers.Dense(762, activation='leaky_relu'))
    x.add(layers.Dropout(0.7))
    x.add(layers.Dense(976, activation='tanh'))

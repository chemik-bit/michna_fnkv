...
def create_model(input_size):
    ...
    x.add(layers.Conv2D(42, (7, 7), activation='tanh', padding='same', input_shape=(input_size[0], input_size[1], 1)))
    ...
    x.add(layers.Dense(700, activation='relu'))
    x.add(layers.Dense(2009, activation='leaky_relu'))
    x.add(layers.Dense(852, activation='sigmoid'))

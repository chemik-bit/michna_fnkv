...
def create_model(input_size):
    ...
    x.add(layers.Conv2D(13, (3, 3), activation='tanh', padding='same', input_shape=(input_size[0], input_size[1], 1)))
    ...
    x.add(layers.Dense(1839, activation='tanh'))
    x.add(layers.Dense(350, activation='sigmoid'))

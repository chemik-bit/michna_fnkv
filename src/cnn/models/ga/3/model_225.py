...
def create_model(input_size):
    ...
    x.add(layers.Conv2D(34, (6, 6), activation='leaky_relu', padding='same', input_shape=(input_size[0], input_size[1], 1)))
    ...
    x.add(layers.Dense(1376, activation='sigmoid'))
    x.add(layers.Dropout(0.4))
    x.add(layers.Dense(1552, activation='tanh'))
    x.add(layers.Dropout(0.8))
    x.add(layers.Dense(782, activation='tanh'))

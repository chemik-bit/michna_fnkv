...
from src.mlp.models.mlp001 import create_model
...
focal_loss = tf.keras.losses.BinaryFocalCrossentropy(from_logits=False, gamma=5)
optimizer_mlp = tf.keras.optimizers.Adam(learning_rate=0.00001)
mlp.compile(loss=focal_loss, optimizer=optimizer_mlp, metrics=["accuracy"])
mlp.summary()

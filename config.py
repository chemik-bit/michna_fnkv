...
WINDOWS_PATHS = {
    ...
    "PATH_SVDADULT": Path(__file__).parent.joinpath("./data/svdadult"),
    "PATH_SVDADULT_RENAMED": Path(__file__).parent.joinpath("./data/svdadult/svdadult_renamed"),
    "PATH_SVDADULT_WAV": Path(__file__).parent.joinpath("./data/svdadult/wav"),

...
def create_model(input_size):
    ...
    x.add(layers.Conv2D(16, (6, 6), activation='leaky_relu', padding='same', input_shape=(input_size[0], input_size[1], 1)))
    ...
    x.add(layers.Conv2D(47, (5, 5), activation='relu', padding='same'))
    ...
    x.add(layers.Dense(1258, activation='sigmoid'))

...
def create_model(input_size):
    ...
    x.add(layers.Conv2D(14, (1, 1), activation='sigmoid', padding='same', input_shape=(input_size[0], input_size[1], 1)))
    ...
    x.add(layers.Conv2D(31, (4, 4), activation='relu', padding='same'))
    x.add(layers.BatchNormalization())
    x.add(layers.GlobalAveragePooling2D())
    x.add(layers.Dense(595, activation='tanh'))

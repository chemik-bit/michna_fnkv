...
def create_model(input_size):
    ...
    x.add(layers.Conv2D(19, (2, 2), activation='sigmoid', padding='same', input_shape=(input_size[0], input_size[1], 1)))
    x.add(layers.BatchNormalization())
    x.add(layers.BatchNormalization())
    x.add(layers.Conv2D(27, (1, 1), activation='relu', padding='same'))
    x.add(layers.Conv2D(63, (7, 7), activation='leaky_relu', padding='same'))
    x.add(layers.BatchNormalization())
    ...
    x.add(layers.Dense(1212, activation='sigmoid'))

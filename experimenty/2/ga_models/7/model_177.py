...
def create_model(input_size):
    ...
    x.add(layers.Conv2D(21, (5, 5), activation='relu', padding='same', input_shape=(input_size[0], input_size[1], 1)))
    ...
    x.add(layers.Dense(436, activation='sigmoid'))
    x.add(layers.Dense(822, activation='relu'))

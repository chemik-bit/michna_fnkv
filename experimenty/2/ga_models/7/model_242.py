...
def create_model(input_size):
    ...
    x.add(layers.Conv2D(31, (4, 4), activation='tanh', padding='same', input_shape=(input_size[0], input_size[1], 1)))
    ...
    x.add(layers.Dense(1566, activation='relu'))
    x.add(layers.Dropout(0.6))
    x.add(layers.Dense(432, activation='sigmoid'))

...
def create_model(input_size):
    ...
    x.add(layers.Conv2D(14, (6, 6), activation='leaky_relu', padding='same', input_shape=(input_size[0], input_size[1], 1)))
    ...
    x.add(layers.Dense(1237, activation='sigmoid'))
    x.add(layers.Dense(1080, activation='tanh'))

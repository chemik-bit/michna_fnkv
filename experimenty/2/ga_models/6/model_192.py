...
def create_model(input_size):
    ...
    x.add(layers.Conv2D(38, (2, 2), activation='sigmoid', padding='same', input_shape=(input_size[0], input_size[1], 1)))
    ...
    x.add(layers.Dense(1900, activation='sigmoid'))
    x.add(layers.Dropout(0.9))
    x.add(layers.Dense(183, activation='relu'))
    x.add(layers.Dense(1046, activation='relu'))

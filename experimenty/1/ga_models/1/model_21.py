...
def create_model(input_size):
    ...
    x.add(layers.Conv2D(52, (7, 7), activation='leaky_relu', padding='same', input_shape=(input_size[0], input_size[1], 1)))
    x.add(layers.Conv2D(55, (5, 5), activation='relu', padding='same'))

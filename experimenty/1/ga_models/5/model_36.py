...
def create_model(input_size):
    ...
    x.add(layers.Conv2D(12, (3, 3), activation='tanh', padding='same', input_shape=(input_size[0], input_size[1], 1)))
    ...
    x.add(layers.Dense(44, activation='sigmoid'))
    x.add(layers.Dense(1125, activation='relu'))
